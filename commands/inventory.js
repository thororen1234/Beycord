...
module.exports.run = async (client, message, args, prefix, ok, db) => {
  ...
  .setTimestamp();
    for(var i in inv){
      ...
      //if(client.blackbeys.include(inv[i].name) || inv[i].name === "Black Perfect Phoenix" || inv[i].name === "Dark Perfect Phoenix") iinfo += "<:black:844767009085587508> | ";
      let type = "<:Balance:844765679295135794>";
      switch(inv[i].type){
        case "Attack":
          type = "<:Attack:844765604325359627>";
        break;
        case "Defense":
          type = "<:Defense:844765628061712424>";
        break;
        case "Stamina":
          type = "<:Stamina:844765656481005580>";
        break;
        default:
          type = "<:Balance:844765679295135794>";
      }
