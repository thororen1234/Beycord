...
module.exports.run = async (client, message, args, prefix, player, db) => {
  ...
  .catch(err => console.error(err));
    ...
    if(collected[0].content.toLowerCase() === "victory valkyrie"){
      ...
      db.collection("users").insertOne({_id: message.author.id, beys: [starter], coins: 100, main: 0, xp: 0, level: 1, faction: "nothing", premium: false, banned: false, redeemed: [], beyparts: [], launcher: "default", items: [pocket], streak: 0, gv: 0, wins: 0, reminder: false, lastVoted: 0, favs: [], perks: [], invsort: "index", settings: {breqs: true, treqs: true, inv: true}, stars: 1, quests: [], qslots: 1, cooldowns: {vote: 0}, won: [], histories: [], hslots: 10, states: {inBattle: false, isTrading: false, isListing: false}, rank: 0, referrer: referrerid});
