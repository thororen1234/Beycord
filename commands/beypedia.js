...
module.exports.run = async (client, message, args, prefix, player, db) => {
  ...
  if(args[0] && client.beys.get(args.join(" ")) && isNaN(parseInt(args[0]))){
    if(args.join(" ") === "Buddy Bey"){
      ...
      .setTimestamp()
      .setThumbnail("https://images.discordapp.net/avatars/842641944093392908/e3ff8924f1d5d41c975907008f0059f2.png?size=512")
    ...
    let rarity;
    if(client.commonbeys.name) rarity = "Common";
    else if(client.rarebeys.name) rarity = "Rare";
    else if(client.legendarybeys.name) rarity = "Legendary";
    else if(client.availablebeys.name) rarity = "Unknown";
    else if(client.blackbeys.name) rarity = "Black";
