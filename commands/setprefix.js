...
module.exports.run = async (client, message, args, prefix, player, db) => {
  ...
  if(!message.member.hasPermission("manageGuild")) return message.reply("buddy you don't meet the requirement to use this command. Missing Permission: ``MANAGE_SERVER``");
