...
const image1 = "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png";
const image2 = "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png";
const image3 = "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png";
const image4 = "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png";
...
module.exports.run = async (client, message, args, prefix, player, db) => {
    ...
    switch (gen) {
        case 1:
            ...
            let images = [main.image, "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png", "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png"];
            let jimps = [];
            ...
            Promise.all(jimps).then(data => {
                ...
                let written = await data[2].writeAsync(`/home/container/tempimages/${message.author.id}gen2.png`);
            });
            ...
            let gen2image;
            try { gen2image = fs.readFileSync(`/home/container/tempimages/${message.author.id}gen2.png`) } catch (err) { message.channel.createMessage(`*Upgrade failed!* Please try again.`); db.collection("users").updateOne({ _id: message.author.id }, { $set: { stars: stats.stars - 1 } }); gen2image = null; };
            if (gen2image) {
                ...
                fs.unlink(`/home/container/tempimages/${message.author.id}gen2.png`, (err) => {
        ...
        case 2:
            ...
            let images2 = [backup.image, "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png", "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png"];
            let jimps2 = [];
            ...
            Promise.all(jimps2).then(data => {
                ...
                data[2].composite(data[1], 0, 0);
                let written = await data[2].writeAsync(`/home/container/tempimages/${message.author.id}gen3.png`);
            });
            //    let wait2 = await client.delay(5000);
            let gen3image;
            try { gen3image = fs.readFileSync(`/home/container/tempimages/${message.author.id}gen3.png`) } catch (err) { message.channel.createMessage(`*Upgrade failed!* Please try again.`); db.collection("users").updateOne({ _id: message.author.id }, { $set: { stars: stats.stars - 1 } }); gen3image = null; };
            if (gen3image) {
                ...
                fs.unlink(`/home/container/tempimages/${message.author.id}gen3.png`, (err) => {
                    if (err) console.log(err);
                });
        ...
        case 3:
            ...
            let images3 = [backup2.image, "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png", "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png"];
            let jimps3 = [];
            ...
            Promise.all(jimps3).then(data => {
                ...
                let written = await data[2].writeAsync(`/home/container/tempimages/${message.author.id}gen4.png`);
            });
            //    let wait3 = await client.delay(5000);
            let gen4image;
            try { gen4image = fs.readFileSync(`/home/container/tempimages/${message.author.id}gen4.png`) } catch (err) { message.channel.createMessage(`*Upgrade failed!* Please try again.`); db.collection("users").updateOne({ _id: message.author.id }, { $set: { stars: stats.stars - 1 } }); gen4image = null; };
            if (gen4image) {
                ...
                fs.unlink(`/home/container/tempimages/${message.author.id}gen4.png`, (err) => {
                    if (err) console.log(err);
                });
        ...
        case 4:
            ...
            let images4 = [backup3.image, "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png", "https://cdn.discordapp.com/attachments/1029534328448884818/1034219096167956480/Untitled188_20221018192449_512x512.png"];
            let jimps4 = [];
            ...
            Promise.all(jimps4).then(data => {
                ...
                let written = await data[2].writeAsync(`/home/container/tempimages/${message.author.id}gen5.png`);
            });
            ...
            *///
            ...
            if (gen5image) {
                ...
                fs.unlink(`/home/container/tempimages/${message.author.id}gen5.gif`, (err) => {
                    if (err) console.log(err);
                });
                fs.unlink(`/home/container/tempimages/${message.author.id}gen5.png`, (err) => {
                    if (err) console.log(err);
                });
