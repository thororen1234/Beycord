...
module.exports.run = async (client, message, args, prefix, player, db) => {
    ...
    switch(gen){
        case 1:
            ...
            let images = [main.image, "C:/beycordplus/images/gen2.png", "C:/beycordplus/images/background.png"];
            let jimps = [];
            ...
            Promise.all(jimps).then(data => {
                ...
                let written = await data[2].writeAsync(`C:/beycordplus/tempimages/${message.author.id}gen2.png`);
            });
            let wait = await client.delay(5000);
            let gen2image;
            try{gen2image = fs.readFileSync(`C:/beycordplus/tempimages/${message.author.id}gen2.png`)}catch(err){message.channel.createMessage(`*Upgrade failed!* Please try again.`);db.collection("users").updateOne({_id: message.author.id}, {$set: {stars: stats.stars - 1}});gen2image = null;};
            if(gen2image){
            ...
            fs.unlink(`C:/beycordplus/tempimages/${message.author.id}gen2.png`, (err) => {
        ...
        case 2:
            ...
            let images2 = [backup.image, "C:/beycordplus/images/gen3.png", "C:/beycordplus/images/background.png"];
            let jimps2 = [];
            ...
            Promise.all(jimps2).then(data => {
                ...
                data[2].composite(data[1], 0, 0);
                let written = await data[2].writeAsync(`C:/beycordplus/tempimages/${message.author.id}gen3.png`);
            });
            let wait2 = await client.delay(5000);
            let gen3image;
            try{gen3image = fs.readFileSync(`C:/beycordplus/tempimages/${message.author.id}gen3.png`)}catch(err){message.channel.createMessage(`*Upgrade failed!* Please try again.`);db.collection("users").updateOne({_id: message.author.id}, {$set: {stars: stats.stars - 1}});gen3image = null;};
            if(gen3image){
            ...
            fs.unlink(`C:/beycordplus/tempimages/${message.author.id}gen3.png`, (err) => {
                if(err) console.log(err);
              });
        ...
        case 3:
            ...
            let images3 = [backup2.image, "C:/beycordplus/images/gen3.png", "C:/beycordplus/images/gen4down.png"];
            let jimps3 = [];
            ...
            Promise.all(jimps3).then(data => {
                ...
                let written = await data[2].writeAsync(`c:/beycordplus/tempimages/${message.author.id}gen4.png`);
            });
            let wait3 = await client.delay(5000);
            let gen4image;
            try{gen4image = fs.readFileSync(`c:/beycordplus/tempimages/${message.author.id}gen4.png`)}catch(err){message.channel.createMessage(`*Upgrade failed!* Please try again.`);db.collection("users").updateOne({_id: message.author.id}, {$set: {stars: stats.stars - 1}});gen4image = null;};
            if(gen4image){
            ...
            fs.unlink(`c:/beycordplus/tempimages/${message.author.id}gen4.png`, (err) => {
                if(err) console.log(err);
              });
        ...
        case 4:
            ...
            let images4 = [backup3.image, "C:/beycordplus/images/gen3.png", "C:/beycordplus/images/gen4down.png"];
            let jimps4 = [];
            ...
            Promise.all(jimps4).then(data => {
                ...
                let written = await data[2].writeAsync(`c:/beycordplus/tempimages/${message.author.id}gen5.png`);
            });
            let wait4 = await client.delay(5000);

            /*
            let encoder = new gifencoder(524, 524);
            encoder.createReadStream().pipe(fs.createWriteStream(`C:/beycordplus/tempimages/${message.author.id}gen5.gif`));
            encoder.start()
            encoder.setRepeat(0);
            encoder.setDelay(83);
            ...
            loadImage(`C:/beycordplus/tempimages/${message.author.id}gen5.png`).then((loadedImage) => {
                for(var i = 0; i < 6; i++){
            ...
            */
            ...
            let gen5image;
            try{gen5image = fs.readFileSync(`c:/beycordplus/tempimages/${message.author.id}gen5.png`)}catch(err){message.channel.createMessage(`*Upgrade failed!* Please try again.`);db.collection("users").updateOne({_id: message.author.id}, {$set: {stars: stats.stars - 1}});gen5image = null;};
            if(gen5image){
            ...
            fs.unlink(`c:/beycordplus/tempimages/${message.author.id}gen5.gif`, (err) => {
                if(err) console.log(err);
              });
              fs.unlink(`c:/beycordplus/tempimages/${message.author.id}gen5.png`, (err) => {
                if(err) console.log(err);
              });
