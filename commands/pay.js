...
module.exports.run = async (client, message, args, prefix, player, db) => {
  ...
  message.channel.createMessage(`✅ <:valtz:999800344848650410>${amount} successfully paid to ${user.effectiveName}.`);
  let webhookembed2 = new Discord.MessageEmbed()
    .setTitle(`${message.author.username}#${message.author.discriminator} (${message.author.id}) paid <:valtz:999800344848650410>${amount} to ${user.username}#${user.discriminator} (${user.id})!`)
    .setTimestamp()
    .setColor("#7f7fff");
