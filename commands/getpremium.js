...
module.exports.run = async (client, message, args, prefix, player, db) => {
  ...
  if(stats.gv < 5){
    message.reply("You don't have enough Golden Valtz. You need 5 Golden Valtz to activate Premium.")
  } else {
    ...
    message.reply("✅Successfully bought NeoBlade Premium! Enjoy your perks :)")
        }
  }
