...
module.exports.run = async (client, message, args, prefix, player, db) => {
  ...
  function itemc() {client.items.get(forsale[item])}
  const iteme = new itemc;
  ...
  if(iteme.civ && stats.coins >= iteme.civ){
    ...
    message.channel.createMessage(`✅Successfully paid <:valtz:844765554237243403>${iteme.civ} and bought a ${iteme.name}!`);
    return;
    ...
    message.channel.createMessage(`✅Successfully paid <:goldenvaltz:844765580748914728>${iteme.cigv} and bought a ${iteme.name}!`);
    return;
